...
namespace grupp_tiger2.UI
{
    public class BankApp
    {
        public static List<bank_user> bankUsers { get; set; }
        public static List<bank_account> bankAccounts { get; set; }

        public static void populateBankUser()
        {
            bankUsers = PostgresDataAccess.LoadBankUsers();
        }

        public static void populateBankAccounts()
        {
        ...
        public void Run()
        {
            ...
            while (correctLogin == false)
            {
                ...
                bank_user user1 = new bank_user(userName, password);
        ...
        public static void mainMenu(bank_user user)
        {
        ...
        public static void adminMenu(bank_user admin)
        {
            Console.Clear();
